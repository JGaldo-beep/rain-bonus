...
description: >
  ...
  accent, the three-step gray text ladder, Poppins (display/numerals/chrome) + Inter (body),
...
colors:
  ...
  text-muted: "#5A5A60"
  text-light: "#9A9AA0"
  accent-light: "rgba(255,68,31,0.08)"
  accent-medium: "rgba(255,68,31,0.15)"
  border: "rgba(255,68,31,0.20)"
  card-bg: "rgba(255,68,31,0.04)"
  positive: "#0FA968"
  negative: "#E5402A"
...
typography:
  # — reading ramp (Inter body + Poppins chrome) —
...
- **Poppins** (display/numerals/chrome) + **Inter** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (Inter body 0.85cqw muted; Poppins eyebrow uppercase 0.08em
...
- **Type** — Poppins headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; Inter body muted line 1.6; ≥1.4cqw floor.
...
- **Poppins + Inter via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
